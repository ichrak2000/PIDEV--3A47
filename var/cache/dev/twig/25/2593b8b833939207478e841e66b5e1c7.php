...
class __TwigTemplate_b0a89232d08188c5f32766f55d18cf6e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ((isset($context["typeReclamation"]) || array_key_exists("typeReclamation", $context) ? $context["typeReclamation"] : (function () { throw new RuntimeError('Variable "typeReclamation" does not exist.', 15, $this->source); })())) {
            ...
            echo "            <div class=\"search-results\">
                ...
                <div class=\"type-reclamation-info\">
                    <p><strong>Nom:</strong> ";
            // line 19
            ...
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["typeReclamation"]) || array_key_exists("typeReclamation", $context) ? $context["typeReclamation"] : (function () { throw new RuntimeError('Variable "typeReclamation" does not exist.', 20, $this->source); })()), "description", [], "any", false, false, false, 20), "html", null, true);
            echo "</p>
...
";
    ...
    {
        return array (  107 => 27,  103 => 25,  95 => 20,  91 => 19,  86 => 16,  84 => 15,  72 => 6,  68 => 4,  58 => 3,  35 => 1,);
    }
        ...
        {% if typeReclamation %}
            <div class=\"search-results\">
                ...
                <div class=\"type-reclamation-info\">
                    ...
                    <p><strong>Description:</strong> {{ typeReclamation.description }}</p>
                    <!-- Ajoutez d'autres informations que vous souhaitez afficher -->
                </div>
            </div>
        {% else %}
...
{% endblock %}", "type_reclamation/recherche.html.twig", "C:\\xampp\\htdocs\\recll\\templates\\type_reclamation\\recherche.html.twig");
    }
}
